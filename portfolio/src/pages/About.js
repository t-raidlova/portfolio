		...
		<Styles>
			...
			<div className="container">
				...
				<div className="experience">
					...
					<ul>
						<li>
							Frontend webdeveloping using CSS3, HTML5, Javascript ES5-ES10,
							ReactJS
						</li>
						<li>Design & prototyping in Adobe Photoshop/Illustrator, Figma</li>
						<li>
							Creating UI with CSS, SCSS/SASS, Bootstrap and React styled
							components
						</li>
						<li>Deploying projects on Heroku &amp; Netlify</li>
